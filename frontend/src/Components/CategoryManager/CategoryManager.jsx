...
export default function CategoryManager({ categories, onEdit, onDelete, setCategories }) {
    const handleDragEnd = (result) => {
      ...
      setCategories(reorderedCategories); // Gọi hàm để cập nhật state
    };
                ...
                {(provided) => (
                  ...
                  >
                    <div className="flex items-center">
                      <div
                        className={`w-4 h-4 rounded-full ${category.color || "bg-gray-500"} mr-4 shadow-sm`}
                      ></div>
